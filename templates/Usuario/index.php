    ...
    <body id="principal">
        ...
        <div class="container">
            <table class="table table-secondary table-bordered caption-top">
                <caption><h1 class="text-black" align="center" style="color:white;"> Gerenciador </h1></caption>
                <thead>
                    <tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <div class="d-grid gap-2 col-6 mx-auto">
                                                    <button type="button" class="btn btn-danger" ><?= $this->Form->postLink(__('Sim, apagar'), ['action' => 'delete', $usuario->id]) ?> <i class="bi bi-trash-fill"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <?}?>
        <div class="text-center" style="color:white;"><?= $this->Paginator->counter(__('Página {{page}} de {{pages}}, Registros {{current}} de {{count}} no total')) ?><div>            
    </body>
</html>
            ...
            <thead class="mb-3">
                <div class="row">
                    <div class="col-6" style="padding-top: 13px;">
                        <h4 style="color: black;"><i class="bi bi-stoplights"></i> Novo Carro <i class="bi bi-stoplights"></i></h4>
                    </div>
                    <div class="col-6">
